    ...
    <div className='add-product'>
        ...
        <div className='addproduct-itemfield'>
            <label htmlFor="file-input">
                <img src={image?URL.createObjectURL(image):'https://tse2.mm.bing.net/th?id=OIP.o2lahLRiKT9iAa2gK1_5YQHaHa&pid=Api&P=0&h=180'} alt='' className='addproduct-thumnail-img'/>
            </label>
